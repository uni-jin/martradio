          ...
          <section className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
            ...
            {visibleSessions.length === 0 ? (
              <div className="mt-6 rounded-xl border border-dashed border-stone-200 bg-stone-50/50 py-10 text-center">
                <p className="text-base text-stone-500">아직 저장된 방송이 없습니다.</p>
              ...
              <div
                className={
                  visibleSessions.length > 10
                    ? "mt-4 max-h-[min(32rem,70vh)] overflow-y-auto overscroll-y-contain pr-1"
                    : "mt-4"
                }
              >
                      ...
                      <li key={session.id}>
                        ...
                        >
                          <div className="flex items-center justify-between gap-3">
                            <span className="max-w-[80%] truncate text-base font-medium text-stone-800">
                              {session.title}
                            </span>
                            <span className="shrink-0 text-stone-400">→</span>
                          </div>
                          <div className="mt-1.5 flex flex-col gap-0.5 text-sm leading-relaxed text-stone-600">
                            <span>
                              <span className="inline-block min-w-[8.5rem] font-semibold text-stone-700">
                                생성일시{" "}
                              </span>
        ...
        {showFreePlanNotice ? (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl">
              <h3 className="text-lg font-semibold text-stone-800">안내</h3>
              ...
              <div className="mt-5 flex justify-end">
                <button
                  type="button"
                  className="rounded-lg bg-amber-500 px-4 py-2.5 text-base font-medium text-white hover:bg-amber-600"
                  onClick={() => {
